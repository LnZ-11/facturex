    ...
    return(
        <header className="flex flex-col text-black">
            <div className="flex flex-row w-full justify-between">
                ...
                {/* Button hidden in PDF, but we can remove it entirely if logic is moved or just keep the date display */}
                {/* For PDF generation, we just want the date. We can rely on invoiceDate being passed correctly. */}
                <h1><u>Beni Douala le:</u> {invoiceDate}</h1>
            </div>
            <div className="flex flex-col w-full justify-between text-xs">
            <h2>HESSAS ABDERRAHIM</h2>
            <h2>VENTE, MAINTENANCE MATERIEL INFORMATIQUE</h2>
            <h2>ACCESSOIRES, PRODUITS INFORMATIQUES, BUREAUTIQUES D'OCCASION</h2>
            <h2>REPARATION, INSTALLATION, MAINTENANCE D'EQUIPEMENTS</h2>
            <h2>MATERIELS DE BUREAUTIQUE, RESEAUX ET TRAITEMENT DE DONNEES</h2>
            ...
            <h2 className="ml-6 mt-6 text-md"><b>Nom du client :</b> {client}</h2>
            </div>
